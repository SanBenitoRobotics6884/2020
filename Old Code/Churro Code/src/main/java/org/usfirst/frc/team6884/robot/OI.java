...
public class OI {
	//// CREATING BUTTONS
	// One type of button is a joystick  on a
	//// joystick.button which is any button
	...
	public static void init() {
		...
		elevatorDownButton = RobotMap.DOWN_ELEVATOR_BUTTON;
		elevatorUpButton = RobotMap.UP_ELEVATOR__BUTTON;
		intakeButton = RobotMap.INTAKE_BUTTON;
		reverseIntakeButton = RobotMap.REVERSE_INTAKE_BUTTON;
