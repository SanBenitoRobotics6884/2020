...
public class Robot extends TimedRobot {
    ...
    private final Encoder m_leftEncoder = new Encoder(0, 1, false, CounterBase.EncodingType.k4X);
    private final Encoder m_rightEncoder = new Encoder(2, 3, false, CounterBase.EncodingType.k4X);
